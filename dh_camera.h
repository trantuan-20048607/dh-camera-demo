...
public:
     ...
     */
    inline bool SetExposureMode(const GX_EXPOSURE_MODE_ENTRY &gx_exposure_mode_entry) {
     ...
     */
    inline bool SetExposureAuto(const GX_EXPOSURE_AUTO_ENTRY &gx_exposure_auto_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
     ...
     */
    inline bool SetExposureTimeMode(const GX_EXPOSURE_TIME_MODE_ENTRY &gx_exposure_time_mode_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
    ...
    inline bool SetExposureTime(int64_t time) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
     ...
     */
    inline bool SetGainAuto(const GX_GAIN_AUTO_ENTRY &gx_gain_auto_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
                                GX_ENUM_GAIN_AUTO,
                                gx_gain_auto_entry);
     ...
     */
    inline bool SetBalanceWhiteAuto(const GX_BALANCE_WHITE_AUTO_ENTRY &gx_balance_white_auto_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
                                GX_ENUM_GAIN_AUTO,
     ...
     */
    inline bool SetTriggerMode(const GX_TRIGGER_MODE_ENTRY &gx_trigger_mode_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
     ...
     */
    inline bool SetTriggerSource(const GX_TRIGGER_SOURCE_ENTRY &gx_trigger_source_entry) {
        GX_STATUS status_code;
        status_code = GXSetEnum(device_,
